<template>
    <div class="space-y-8">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">
                    Create reusable templates for common addons and services
                </p>
            </div>
            <button
        ...
        <div
            v-else-if="addonTemplates && addonTemplates.length > 0"
                ...
                >
                    <div class="flex-1">
                        <div class="flex items-center mb-1">
                            ...
                            <span
                                class="ml-2 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800"
                            >
                        ...
                        <div class="text-xs text-gray-500 mt-1 space-x-4">
                            <span v-if="template.sku"
                                >SKU: {{ template.sku }}</span
                            >
                            <span>Qty: {{ template.default_quantity }}</span>
                            <span
                                v-if="template.billable"
                                class="text-green-600"
                                >Billable</span
                            >
                            <span
                                v-if="template.is_taxable"
                                class="text-blue-600"
                                >Taxable</span
                            >
                        </div>
