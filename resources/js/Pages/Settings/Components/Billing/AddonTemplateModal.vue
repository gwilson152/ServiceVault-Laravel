                            ...
                            <form @submit.prevent="saveTemplate">
                                <div>
                                    ...
                                    <div class="mt-4 space-y-6">
                                        ...
                                        <!-- Preview -->
                                        <div
                                            class="bg-gray-50 px-4 py-3 rounded-lg border-t border-gray-200"
                                        >
                                            <div
...
const calculatedTotal = computed(() => {
    const subtotal =
        (parseFloat(form.default_unit_price) || 0) *
        (parseFloat(form.default_quantity) || 0);
    const taxAmount = form.is_taxable
        ? subtotal * ((parseFloat(form.default_tax_rate) || 0) / 100)
        : 0;
