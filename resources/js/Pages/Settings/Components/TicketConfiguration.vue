    ...
    <div class="space-y-8">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-2">
                Manage ticket statuses, categories, workflow, and attachment
                settings.
            </p>
        </div>
                    ...
                    <div v-if="statuses && statuses.length > 0">
                        ...
                        >
                            <template #item="{ element: status }">
                                ...
                                >
                                    <div
                                        class="flex items-center mr-2 text-gray-400"
                                    >
                                        <svg
                                            class="w-4 h-4"
                                            fill="none"
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div
                                            class="text-xs text-gray-500 space-x-2"
                                        >
                                            <span>{{
                                                status.is_closed
                                                    ? "Closed"
                            ...
                            <template #item="{ element: category }">
                                ...
                                >
                                    <div class="flex items-center mb-2">
                                        ...
                                        ></div>
                                        <h4
                                            class="text-sm font-medium text-gray-900 flex-1"
                                        >
                                            {{ category.name }}
                                        </h4>
                                        <span
                                        ...
                                        <button
                                            ...
                                            class="opacity-0 group-hover:opacity-100 transition-opacity p-1 text-gray-400 hover:text-blue-600"
                                        >
                                            <svg
                                                class="w-4 h-4"
                                                fill="none"
                                    ...
                                    >
                                        ...
                                        <div
                                            v-if="
                                                category.default_estimated_hours
                                            "
                                        >
                                            Est:
                                            {{
                                ...
                                >
                                    ...
                                    <div class="flex-1">
                                        ...
                                        >
                                            ...
                                            <span
                                                v-if="
                                                    priority.escalation_multiplier !==
                                                    1.0
                                                "
                                            >
                                                SLA:
                                    ...
                                    >
                                        <button
                                            @click.stop="editPriority(priority)"
                                            class="p-1 text-gray-400 hover:text-blue-600"
                                        >
                                            <svg
                                                class="w-4 h-4"
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Configure file upload limits and allowed file
                                types for ticket messages.
                            </p>
                        </div>
                        <button
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm text-gray-700 mb-2"
                                    >Maximum Files Per Message</label
                                >
                                <input
                                    v-model.number="
                                        attachmentSettings.max_files
                                    "
                                    type="number"
                                    min="1"
                                    max="20"
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    Users can upload up to this many files in a
                                    single message (1-20)
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-2">
                                    <input
                                        v-model.number="
                                            attachmentSettings.max_file_size_mb
                                        "
                                        type="number"
                                        min="1"
                                        max="100"
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    Maximum size for individual files (1-100 MB)
                                </p>
                            </div>

                            <div>
                                <label class="block text-sm text-gray-700 mb-2"
                                    >Total Upload Limit</label
                                >
                                <div class="flex items-center space-x-2">
                                    <input
                                        v-model.number="
                                            attachmentSettings.total_size_limit_mb
                                        "
                                        type="number"
                                        min="1"
                                        max="500"
                                    ...
                                    />
                                    <span class="text-sm text-gray-500"
                                        >MB total per message</span
                                    >
                                </div>
                                <p class="text-xs text-gray-500 mt-1">
                                    Maximum combined size for all files in one
                                    message
                                </p>
                            </div>
                        </div>
                                    ...
                                    >
                                        ...
                                        >
                                            <input
                                                type="checkbox"
                                                :checked="
                                                    category.extensions.every(
                                                        (ext) =>
                                                            attachmentSettings.allowed_extensions.includes(
                                                                ext
                                                            )
                                                    )
                                                "
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="mt-2">
                                ...
                                <span class="font-medium text-gray-900 ml-1"
                                    >{{
                                        attachmentSettings.allowed_extensions
                                            .length
                                    }}
                                    extensions</span
                                >
...
const workflowTransitions = computed(
    () => props.config.workflow_transitions || {}
);

// Computed for custom extensions (not in predefined categories)
const customExtensions = computed(() => {
    const predefinedExtensions = fileTypeCategories.value.flatMap(
        (cat) => cat.extensions
    );
    return attachmentSettings.value.allowed_extensions.filter(
        (ext) => !predefinedExtensions.includes(ext)
    );
});
...
watch(
    () => props.config.attachment_settings,
    (newSettings) => {
        if (newSettings) {
            attachmentSettings.value = {
                max_files: newSettings.max_files || 10,
                max_file_size_mb: Math.ceil(
                    (newSettings.max_file_size_kb || 10240) / 1024
                ),
                total_size_limit_mb: Math.ceil(
                    (newSettings.total_size_limit_kb || 51200) / 1024
                ),
                allowed_extensions: newSettings.allowed_extensions || [
                    ...defaultExtensions,
                ],
            };
        } else {
            // Set defaults if no settings exist
            attachmentSettings.value.allowed_extensions = [
                ...defaultExtensions,
            ];
        }
    },
...
const saveAttachmentSettings = async () => {
    ...
    try {
        const settingsData = {
            ...
            "tickets.attachments.max_file_size_kb":
                attachmentSettings.value.max_file_size_mb * 1024,
            "tickets.attachments.total_size_limit_kb":
                attachmentSettings.value.total_size_limit_mb * 1024,
...
const toggleCategory = (category) => {
    const allIncluded = category.extensions.every((ext) =>
        attachmentSettings.value.allowed_extensions.includes(ext)
    );

    if (allIncluded) {
        // Remove all extensions from this category
        attachmentSettings.value.allowed_extensions =
            attachmentSettings.value.allowed_extensions.filter(
...
const addCustomExtension = () => {
    const extension = newExtension.value
        .trim()
        .toLowerCase()
    ...
    if (
        extension &&
        !attachmentSettings.value.allowed_extensions.includes(extension)
    ) {
...
const removeCustomExtension = (extension) => {
    const index =
        attachmentSettings.value.allowed_extensions.indexOf(extension);
    if (index > -1) {
