                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                      ...
                      <div>
                        <label for="default_unit_price" class="block text-sm font-medium leading-6 text-gray-900">
                          Default Unit Price <span class="text-red-500">*</span>
                        </label>
                        <div class="mt-2">
                          <div class="relative">
...
const saving = computed(() => createTemplateMutation.isPending.value || updateTemplateMutation.isPending.value)
...
watch(() => props.template, (template) => {
  if (template) {
    ...
    form.default_unit_price = parseFloat(template.default_unit_price) || 0
