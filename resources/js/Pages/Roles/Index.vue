            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Manage role templates with three-dimensional permissions: functional, widget, and page access
                    </p>
                </div>
                <!-- Header Section -->
                <div class="mb-6 flex justify-between items-center">
                    <div>
                        <h3 class="text-lg font-medium text-gray-900">Role Templates</h3>
                        <p class="mt-1 text-sm text-gray-600">
                            Manage role templates with three-dimensional permissions: functional, widget, and page access
                        </p>
                    </div>
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-md">
                    <div v-if="loading" class="px-4 py-5 sm:p-6">
                        <div class="flex items-center justify-center">
                            ...
                            <span class="ml-2 text-gray-600">Loading role templates...</span>
                        </div>
                    </div>
                    ...
                    <ul v-else-if="roleTemplates.length > 0" role="list" class="divide-y divide-gray-200">
                        <li v-for="template in roleTemplates" :key="template.id" class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="flex items-center">
                                            ...
                                            <span v-if="!template.is_modifiable" class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                                System Role
                                            </span>
                                            <span v-if="template.is_default" class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                Default
                                            </span>
                                        </div>
                                        <p class="text-sm text-gray-500">{{ template.description }}</p>
                                        <div class="mt-1 flex items-center text-xs text-gray-500">
                                            <span>{{ template.users_count }} users</span>
                                            <span class="mx-2">•</span>
                                            <span>{{ template.permission_counts.functional }} functional</span>
                                            <span class="mx-2">•</span>
                                            <span>{{ template.permission_counts.widget }} widget</span>
                                            <span class="mx-2">•</span>
                                            <span>{{ template.permission_counts.page }} page permissions</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button
                                        type="button"
                                        class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                        @click="$inertia.visit(route('roles.show', template.id))"
                                    >
                                        View
                                    </button>
                                    <button
                                        ...
                                        @click="$inertia.visit(route('roles.edit', template.id))"
                                    >
                                        Edit
                                    </button>
                                </div>
                    ...
                    <div v-else class="px-4 py-5 sm:p-6">
                        <div class="text-center">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">No role templates</h3>
                            <p class="mt-1 text-sm text-gray-500">Get started by creating your first role template.</p>
                            <div class="mt-6">
                                <button
                                    type="button"
