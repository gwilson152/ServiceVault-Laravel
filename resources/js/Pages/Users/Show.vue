                    ...
                    >
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p
                                    class="text-2xl font-semibold text-purple-600"
                                >
                                    {{
                                        formatDuration(
                                            user.statistics
...
const { data: roleTemplatesData, isLoading: roleTemplatesLoading } =
...
const { data: ticketsData, isLoading: ticketsLoading } =
    useUserTicketsQuery(userId);
const { data: timeEntriesData, isLoading: timeEntriesLoading } =
    useUserTimeEntriesQuery(userId);
...
const loading = computed(
    () =>
        userLoading.value || accountsLoading.value || roleTemplatesLoading.value
);
