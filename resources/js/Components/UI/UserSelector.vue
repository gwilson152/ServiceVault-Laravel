    ...
    <div class="relative">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p
                            v-if="selectedUser.role_template?.name"
                            class="text-xs text-blue-600"
                        >
                            {{ selectedUser.role_template.name }}
                        </p>
                    </div>
                </div>
                <button
        ...
        >
            ...
            <div v-else>
                    ...
                    >
                        <div class="flex items-center">
                            ...
                            <div class="flex-1">
                                ...
                                <p
                                    v-if="user.role_template?.name"
                                    class="text-xs text-gray-500"
                                >
                                    {{ user.role_template.name }}
                                </p>
                                <p
                                    v-if="user.account?.name"
                ...
                <div
                    v-if="filteredUsers.length === 0 && !showCreateOption"
                ...
                <div
                    v-else-if="filteredUsers.length === 0 && showCreateOption"
                    class="px-4 py-2 text-xs text-gray-500 text-center border-t border-gray-100"
                >
                    {{
                        searchTerm
                            ? "No existing users match your search"
                            : "No existing users"
                    }}
                </div>
            </div>
...
const filteredUsers = computed(() => {
    ...
    return props.users.filter(
        (user) =>
            ...
            (user.role_template?.name &&
                user.role_template.name.toLowerCase().includes(term)) ||
            (user.account?.name &&
