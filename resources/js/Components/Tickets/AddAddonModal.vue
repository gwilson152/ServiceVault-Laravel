    ...
    >
        <div class="space-y-4">
            <p class="text-sm text-gray-600">
                Add additional items, services, or charges to this ticket
            </p>
                    ...
                    <div class="flex">
                        ...
                        <div class="text-sm">
                            ...
                            <p class="text-blue-600 mt-1">
                                New add-ons will be created with "{{
                                    form.status
                                }}" status and may require approval before
                                billing.
                            </p>
                        </div>
                    </div>
...
const submitForm = async () => {
    ...
    try {
        ...
        if (error.response?.data?.errors) {
            ...
            errors.value = {
                general: "Failed to create add-on request. Please try again.",
            };
        }
    } finally {
