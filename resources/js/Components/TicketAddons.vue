        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div v-else-if="addons.length === 0" class="text-center py-8">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Get started by adding an addon to this ticket.
                </p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                <span v-if="addon.sku" class="mr-4"
                                    >SKU: {{ addon.sku }}</span
                                >
                                <span class="mr-4"
                                    >Qty: {{ addon.quantity }}</span
                                >
                                <span class="mr-4"
                                    >Unit:
                                    {{ formatPrice(addon.unit_price) }}</span
                                >
                                <span
                                    v-if="addon.discount_amount > 0"
                                    class="mr-4 text-orange-600"
                                >
                                    Discount: -{{
                                        formatPrice(addon.discount_amount)
                                    }}
                                </span>
                            </div>
                            ...
                            <div class="mt-2 flex items-center justify-between">
                                <div class="text-sm text-gray-500">
                                    Added by
                                    {{ addon.added_by?.name || "Unknown" }} on
