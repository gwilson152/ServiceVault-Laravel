    ...
    protected function getNavigationItems(): array
    {
        return [
            ...
            [
                ...
                'label' => 'Time & Addons',
                'icon' => 'CalendarIcon',
                'route' => 'time-and-addons.index',
                'active_patterns' => ['time-and-addons.*'],
            ...
            [
                ...
                'active_patterns' => ['admin.email.*', 'settings.email.*'],
                'permissions' => ['email.admin.manage', 'admin.manage', 'system.manage'],
                'sort_order' => 10,
                'group' => 'administration',
                'subitems' => [
                    [
                    ...
                    [
                        'key' => 'email-monitoring',
                        'label' => 'Processing Monitor',
                        'route' => 'admin.email.monitoring',
                        'permissions' => ['email.admin.manage', 'admin.manage', 'system.manage'],
                    ],
                    [
                        'key' => 'email-templates',
                    ...
                    [
                        'key' => 'email-commands',
                        'label' => 'Subject Commands',
                        'route' => 'settings.email.commands',
                        'permissions' => ['email.admin.manage', 'admin.manage', 'system.manage'],
                    ],
                ],
            ],
